...
using WebStore_1.Providers;
using WebStore_1.Results;
    ...
    public class AccountApiController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            using (var context = new ApplicationDbContext())
            {
                ...
                await roleManager.CreateAsync(new IdentityRole() { Name = "UserConsoleClient" });
                ...
                await userManager.AddToRoleAsync(user.Id, "UserConsoleClient");
